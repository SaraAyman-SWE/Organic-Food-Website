            ...
            <ul>
                ...
                <li><a href="#">Pages</a>
                    <ul class="header__menu__dropdown">
                        ...
                        <li><a href="./blog-details.html">Blogs</a></li>
                    </ul>
                </li>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            ...
                            <div class="blog__item">
                                ...
                                <div class="blog__item__text">
                                    ...
                                    <div style=" text-overflow:ellipsis; overflow:hidden; white-space:nowrap; "> {{$blog->blogcontent}} </div>
                                    
                                    <a href="{{route('blogdetails', $blog->blogid)}}" class="blog__btn">READ MORE <span class="arrow_right"></span></a>
                                </div>
