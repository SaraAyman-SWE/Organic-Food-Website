        ...
        <div class="container">
            <div class="row">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Welcome to OrganicFood an eCommerce website</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
                    ...
                    <div class="hover-team">
                        <div class="our-team"> <img src="images/img-1.jpg" alt="" />
                            <div class="team-content">
                                <h3 class="title">Serkan Bolat</h3> <span class="post">Owner</span> </div>
                            <ul class="social">
                                <li>
                                    <a href="#" class="icon_mail_alt"></a>
                                </li>
                            </ul>
                            <div class="icon"> <i class="icon_profile" aria-hidden="true"></i> </div>
                        </div>
                        <div class="team-description">
                            <p>Owner of the famous archeticture company artlife, loves fitness and knows helping people to eat healthy is a must!</p>
                        </div>
                        <hr class="my-0"> </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        <div class="our-team"> <img src="images/img-2.jpg" alt="" />
                            <div class="team-content">
                                <h3 class="title">Kaan Karadag</h3> <span class="post">CEO</span> </div>
                            <ul class="social">
                                <li>
                        ...
                        <div class="team-description">
                            <p>Our CEO knows how important it is to hire only trusted and excellent employees</p>
                        </div>
                        <hr class="my-0"> </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        <div class="our-team"> <img src="images/img-3.jpg" alt="" />
                            <div class="team-content">
                                <h3 class="title">Engin Sezgin</h3> <span class="post">Sales manager</span> </div>
                            <ul class="social">
                                <li>
                                    <a href="#" class="icon_mail_alt"></a>
                                </li>
                        ...
                        <div class="team-description">
                            <p>Ensures our relationship with you guys is always perfect! we never want to fail you! </p>
                        </div>
                        <hr class="my-0"> </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        <div class="our-team"> <img src="images/img-4.jpg" alt="" />
                            <div class="team-content">
                                <h3 class="title">Ferit Simsek</h3> <span class="post">Head chef</span> </div>
                            <ul class="social">
                                <li>
                                    <a href="#" class="icon_mail"></a>
                                </li>
                        ...
                        <div class="team-description">
                            <p>One of the top chefs in the world! speciallized in nurtrition to ensure everything in the kitchen is perfectly perfect!</p>
                        </div>
                        <hr class="my-0"> </div>
                </div>
        </div>
